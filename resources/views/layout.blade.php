...
<head>
    ...
    <link href="{{ asset('frontend/css/html-content.css') }}" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" rel="stylesheet" />
    <style>
        /* CSS cho menu cấp 3 */
        .megamenusub ul li ul {
            display: none;
            position: absolute;
            left: 100%;
            top: 0;
        ...
        .megamenusub ul li:hover>ul {
            display: block;
        }

        .megamenusub ul li ul li {
            padding: 8px 15px;
            border-bottom: 1px solid #eee;
            position: relative;
        }

        .megamenusub ul li ul li:last-child {
            border-bottom: none;
        }

        .megamenusub ul li ul li a {
            color: #333;
            font-size: 14px;
            display: block;
        ...
        .megamenusub ul li ul li a:hover {
            color: #ffc700;
            padding-left: 5px;
        }

        .megamenusub ul li ul li a i.fa-angle-right {
            margin-right: 8px;
            font-size: 12px;
        }

        /* Hiệu ứng hover */
        .megamenusub ul li ul li:hover {
            background-color: #f8f9fa;
        }

        /* Responsive cho menu cấp 3 */
        ...
        .box-wap-imgpr {
            width: 100%;
            height: 65%;
            /* Chiều cao cố định, có thể chỉnh lại theo ý bạn */
            display: flex;
            align-items: center;
                                                ...
                                                @foreach ($categories as $key => $sub_cate)
                                                    @if ($sub_cate->category_parent == $cate->id)
                                                        <li class="" style="border-color:white">
                                                            ...
                                                            <ul>
                                                                @foreach ($categories as $key => $sub_sub_cate)
                                                                    @if ($sub_sub_cate->category_parent == $sub_cate->id)
                                                                        <li class="" style="border-color:white">
                                                                            <a href="{{ route('tour', [$sub_sub_cate->slug]) }}"
                                                                                class="">
    ...
    <div class="container" id="form-search">
        <div class="row">
            <div class="w100 fl bx-wap-form-search">
                <form method="GET" action="{{ route('tours.search') }}" accept-charset="UTF-8" class="">
                    <div class="col-md-10 col-xs-12 bx-fr-left">
                        <div class="form-group col-dk-2 col-md-4 col-xs-12">
                            <input type="text" name="search" value="{{ request('search') }}"
                                class="form-control" placeholder="Tìm kiếm điểm đến">
                        </div>
                        <div class="form-group col-dk-2 col-md-4 col-xs-12">
        ...
        <div class="col-md-12 col-xs-12 top-30 lst-tour-position">
            <div class="row">
                ...
                <div class="row equal-height-row">
                    @if (!empty($category_footer) && count($category_footer) > 0)
                ...
                <div class="col-md-3 col-xs-12">
                    ...
                    <div class="w100 fl">
                        ...
                        <ul class="ulfooter-contact2 w50">
                            ...
                            <li><a href="">2/ thanh toán chuyển khoản</a></li>
