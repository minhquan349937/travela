...
<head>
    ...
    <!-- Favicon Icon -->
    <link rel="shortcut icon" href="{{ assets('clients/images/logos/favicon.png')}}" type="image/x-icon">
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&amp;display=swap" rel="stylesheet">
    
    <!-- Flaticon -->
    <link rel="stylesheet" href="{{ assets('clients/css/flaticon.min.css')}}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ assets('clients/css/fontawesome-5.14.0.min.css') }}">
    <!-- Bootstrap -->
    <link rel="stylesheet" href="{{ assets('clients/css/bootstrap.min.css') }}">
    <!-- Magnific Popup -->
    <link rel="stylesheet" href="{{ assets('clients/css/magnific-popup.min.css')}}">
    <!-- Nice Select -->
    <link rel="stylesheet" href="{{ assets('clients/css/nice-select.min.css')}}">
    <!-- Animate -->
    <link rel="stylesheet" href="{{ assets('clients/css/aos.css')}}">
    <!-- Slick -->
    <link rel="stylesheet" href="{{ assets('clients/css/slick.min.css')}}">
    <!-- Main Style -->
...
<body>
    <div class="page-wrapper">
                ...
                <div class="container-fluid clearfix">
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="index.html"><img src="clients/images/logos/logo.png" alt="Logo" title="Logo"></a></div>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                <div class="navbar-header">
                                   <div class="mobile-logo">
                                       <a href="index.html">
                                            <img src="clients/images/logos/logo.png" alt="Logo" title="Logo">
                                       </a>
                                   </div>
        ...
        <section class="hero-area bgc-black pt-200 rpt-120 rel z-2">
            <div class="container-fluid">
                ...
                <div class="main-hero-image bgs-cover" style="background-image: url(clients/images/hero/hero.jpg);"></div>
            </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="destination-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                ...
                                <img src="clients/images/destinations/visiting-place1.jpg" alt="Destination">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="destination-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="clients/images/destinations/visiting-place2.jpg" alt="Destination">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="destination-item" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="clients/images/destinations/visiting-place3.jpg" alt="Destination">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="destination-item" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="clients/images/destinations/visiting-place4.jpg" alt="Destination">
                            </div>
                            <div class="content">
                                <span class="location"><i class="fal fa-map-marker-alt"></i> Rome, Italy</span>
                                <h5><a href="destination-details.html">Woman standing near Colosseum, Rome</a></h5>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-7 col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                        <div class="about-us-image">
                            <div class="shape"><img src="clients/images/about/shape1.png" alt="Shape"></div>
                            <div class="shape"><img src="clients/images/about/shape2.png" alt="Shape"></div>
                            <div class="shape"><img src="clients/images/about/shape3.png" alt="Shape"></div>
                            <div class="shape"><img src="clients/images/about/shape4.png" alt="Shape"></div>
                            <div class="shape"><img src="clients/images/about/shape5.png" alt="Shape"></div>
                            <div class="shape"><img src="clients/images/about/shape6.png" alt="Shape"></div>
                            <div class="shape"><img src="clients/images/about/shape7.png" alt="Shape"></div>
                            <img src="clients/images/about/about.png" alt="About">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-3 col-md-6">
                                <div class="destination-item style-two" data-aos="flip-up" data-aos-duration="1500" data-aos-offset="50">
                                    <div class="image">
                                        <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                        <img src="clients/images/destinations/destination1.jpg" alt="Destination">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="destination-item style-two" data-aos="flip-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                                    <div class="image">
                                        <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                        <img src="clients/images/destinations/destination2.jpg" alt="Destination">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-md-6">
                                <div class="destination-item style-two" data-aos="flip-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                                    <div class="image">
                                        <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                        <img src="clients/images/destinations/destination3.jpg" alt="Destination">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-md-6">
                                <div class="destination-item style-two" data-aos="flip-up" data-aos-duration="1500" data-aos-offset="50">
                                    <div class="image">
                                        <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                        <img src="clients/images/destinations/destination4.jpg" alt="Destination">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="destination-item style-two" data-aos="flip-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                                    <div class="image">
                                        <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                        <img src="clients/images/destinations/destination5.jpg" alt="Destination">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="destination-item style-two" data-aos="flip-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                                    <div class="image">
                                        <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                        <img src="clients/images/destinations/destination6.jpg" alt="Destination">
                                    </div>
                                    <div class="content">
                    ...
                    <div class="col-xl-6">
                        <div class="features-content-part mb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="features-customer-box">
                                <div class="image">
                                    <img src="clients/images/features/features-box.jpg" alt="Features">
                                </div>
                                <div class="content">
                                    <div class="feature-authors mb-15">
                                        <img src="clients/images/features/feature-author1.jpg" alt="Author">
                                        <img src="clients/images/features/feature-author2.jpg" alt="Author">
                                        <img src="clients/images/features/feature-author3.jpg" alt="Author">
                                        <span>4k+</span>
                                    </div>
                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-10">
                        <div class="destination-item style-three" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="clients/images/destinations/hotel1.jpg" alt="Hotel">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-10">
                        <div class="destination-item style-three" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="clients/images/destinations/hotel2.jpg" alt="Hotel">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-10">
                        <div class="destination-item style-three" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="clients/images/destinations/hotel3.jpg" alt="Hotel">
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-8 col-lg-10">
                        <div class="destination-item style-three" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="clients/images/destinations/hotel4.jpg" alt="Hotel">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-5">
                        <div class="mobile-app-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="google-play-app-store">
                                <a href="#"><img src="clients/images/mobile-app/g-play.jpg" alt="Google Play"></a>
                                <a href="#"><img src="clients/images/mobile-app/a-store.jpg" alt="App Store"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="mobile-app-images">
                            <div class="bg"><img src="clients/images/mobile-app/phone-bg.png" alt="BG"></div>
                            <div class="images">
                                <img src="clients/images/mobile-app/phone2.png" alt="Phone" data-aos="fade-down-left" data-aos-duration="1500" data-aos-offset="50">
                                <img src="clients/images/mobile-app/phone.png" alt="Phone">
                                <img src="clients/images/mobile-app/phone3.png" alt="Phone" data-aos="fade-up-right" data-aos-duration="1500" data-aos-offset="50">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonials-wrap bgc-lighter">
                    <div class="row">
                        <div class="col-lg-5 rel" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                            <div class="testimonial-left-image rmb-55" style="background-image: url(clients/images/testimonials/testimonial-left.jpg);"></div>
                        </div>
                        <div class="col-lg-7">
                            <div class="testimonial-right-content" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <div class="testimonials-active">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="author">
                                            <div class="image"><img src="clients/images/testimonials/author.jpg" alt="Author"></div>
                                            <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-duration="1500" data-aos-offset="50">
                        <div class="cta-item" style="background-image: url(clients/images/cta/cta1.jpg);">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                        <div class="cta-item" style="background-image: url(clients/images/cta/cta2.jpg);">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <img src="clients/images/blog/blog1.jpg" alt="Blog">
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <img src="clients/images/blog/blog2.jpg" alt="Blog">
                            </div>
                            <a href="blog-details.html" class="theme-btn">
                                <span data-hover="Book Now">Read More</span>
                                <i class="fal fa-arrow-right"></i>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <img src="clients/images/blog/blog3.jpg" alt="Blog">
                            </div>
                            <a href="blog-details.html" class="theme-btn">
                                <span data-hover="Book Now">Read More</span>
                                <i class="fal fa-arrow-right"></i>
        ...
        <footer class="main-footer bgs-cover overlay rel z-1 pb-25" style="background-image: url(assets/images/backgrounds/footer.jpg);">
                        ...
                        <div class="col-xl-5 col-lg-6" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <div class="footer-widget footer-text">
                                <div class="footer-logo mb-25">
                                    <a href="index.html"><img src="clients/images/logos/logo.png" alt="Logo"></a>
                                </div>
            ...
            <div class="footer-bottom pt-20 pb-5">
                <div class="container">
                    ...
                    <!-- Scroll Top Button -->
                    <button class="scroll-top scroll-to-target" data-target="html"><img src="clients/images/icons/scroll-up.png" alt="Scroll  Up"></button>
                </div>
            </div>
        </footer>
        <!-- footer area end -->
    ...
    <!-- Appear Js -->
    <script src="{{ assets('clients/js/appear.min.js')}}"></script>
    <!-- Slick -->
    <script src="{{ assets('clients/js/slick.min.js')}}"></script>
    <!-- Magnific Popup -->
    <script src="{{ assets('clients/js/jquery.magnific-popup.min.js')}}"></script>
    <!-- Nice Select -->
    <script src="{{ assets('clients/js/jquery.nice-select.min.js')}}"></script>
    <!-- Image Loader -->
    <script src="{{ assets('clients/js/imagesloaded.pkgd.min.js')}}"></script>
    <!-- Skillbar -->
    <script src="{{ assets('clients/js/skill.bars.jquery.min.js')}}"></script>
    <!-- Isotope -->
    <script src="{{ assets('clients/js/isotope.pkgd.min.js')}}"></script>
    <!--  AOS Animation -->
    <script src="{{ assets('clients/js/aos.js')}}"></script>
    <!-- Custom script -->
    <script src="{{ assets('clients/js/script.js')}}"></script>
