            ...
            <div class="col-xxl-3 col-xl-4 col-md-6">
                <div class="destination-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500"
                    ...
                    <div class="content">
                        ...
                        <h5><a href="destination-details.html">Blue lake water view taken travel with daytime</a>
                        </h5>
                        <span class="time">3 days 2 nights - Couple</span>
                    </div>
                    <div class="destination-footer">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="mobile-app-content rmb-55" data-aos="fade-left" data-aos-duration="1500"
                    ...
                    <p>We go above and beyond to make your travel dreams a reality. Trust us to handle the details
                        so you can creating unforgettable memories. Explore the world with confidence</p>
                    ...
                    <div class="testimonial-right-content" data-aos="fade-left" data-aos-duration="1500"
                        ...
                        <div class="testimonials-active">
                            <div class="testimonial-item">
                                ...
                                <div class="text">"Our trip was absolutely a perfect, thanks this travel agency!
                                    They took care of every detail, from to accommodations, and even suggested
                                    incredible experiences"</div>
                                <div class="author">
